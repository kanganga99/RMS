                    ...
                    <tbody>
                        @foreach ($vacantrooms as $item)
                            <tr>
                                ...
                                <td>{{ $item->floor }}</td>
                                <td>
                                    <a href="{{ url('vacantrooms/edit/' .$item->id )}}" title="Edit vacant room"><button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#edit_modal"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
