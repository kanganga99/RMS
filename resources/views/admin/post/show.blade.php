            ...
            <table id="example" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href=" {{ route('post.edit',$post->id) }}"><ion-icon name="create-outline"></ion-icon></a></td>

                  <form method="post" action="{{ route('post.destroy',$post->id) }}" id="delete-form-{{ $post->id }}" style="display: none">
                    @csrf
                    {{ method_field('DELETE') }}
                  </form>
