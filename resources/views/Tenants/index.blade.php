            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($tenants as $item)
                    <tr>
                        ...
                        <td>{{ $item->password }}</td>
                        <td>
                            <a href="{{ url('/tenants/' . $item->id )}}" title="View tenant"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                            <a href="{{ url('/tenants/' . $item->id . '/edit')}}" title="Edit tenant"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
